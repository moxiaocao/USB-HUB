...
void setup_scr_USB_control_2(lv_ui *ui)
{
	...
	if(flag.control_sw_3==1)
	{
		lv_obj_add_state(ui->USB_control_2_sw_3, LV_STATE_CHECKED);
	}
	if(flag.control_sw_4==1)
	{
		lv_obj_add_state(ui->USB_control_2_sw_4, LV_STATE_CHECKED);
	}
	if(flag.control_sw_5==1)
	{
		lv_obj_add_state(ui->USB_control_2_sw_5, LV_STATE_CHECKED);
	}
	if(flag.control_sw_6==1)
	{
		lv_obj_add_state(ui->USB_control_2_sw_6, LV_STATE_CHECKED);
	}
