...
void setup_scr_USB_Data_4(lv_ui *ui)
{
	...
	lv_arc_set_range(ui->USB_Data_4_arc_1, 0, 330);
	lv_arc_set_bg_angles(ui->USB_Data_4_arc_1, 135, 45);
	lv_arc_set_value(ui->USB_Data_4_arc_1, 200);
    ...
    lv_obj_remove_style(ui->USB_Data_4_arc_1, NULL, LV_PART_KNOB); /* 移除旋钮 */
    lv_obj_clear_flag(ui->USB_Data_4_arc_1, LV_OBJ_FLAG_CLICKABLE); /* 清除可点击属性 */
	...
	lv_arc_set_range(ui->USB_Data_4_arc_2, 0, 330);
	lv_arc_set_bg_angles(ui->USB_Data_4_arc_2, 135, 45);
	lv_arc_set_value(ui->USB_Data_4_arc_2, 100);
	...
	lv_obj_remove_style(ui->USB_Data_4_arc_2, NULL, LV_PART_KNOB); /* 移除旋钮 */
    lv_obj_clear_flag(ui->USB_Data_4_arc_2, LV_OBJ_FLAG_CLICKABLE); /* 清除可点击属性 */
	...
	lv_arc_set_range(ui->USB_Data_4_arc_3, 0, 330);
	lv_arc_set_bg_angles(ui->USB_Data_4_arc_3, 135, 45);
	lv_arc_set_value(ui->USB_Data_4_arc_3, 250);
	...
	lv_obj_remove_style(ui->USB_Data_4_arc_3, NULL, LV_PART_KNOB); /* 移除旋钮 */
    lv_obj_clear_flag(ui->USB_Data_4_arc_3, LV_OBJ_FLAG_CLICKABLE); /* 清除可点击属性 */
	...
	lv_arc_set_range(ui->USB_Data_4_arc_6, 0, 330);
	lv_arc_set_bg_angles(ui->USB_Data_4_arc_6, 135, 45);
	lv_arc_set_value(ui->USB_Data_4_arc_6, 75);
	...
	lv_obj_remove_style(ui->USB_Data_4_arc_6, NULL, LV_PART_KNOB); /* 移除旋钮 */
    lv_obj_clear_flag(ui->USB_Data_4_arc_6, LV_OBJ_FLAG_CLICKABLE); /* 清除可点击属性 */
	...
	lv_arc_set_range(ui->USB_Data_4_arc_5, 0, 330);
	lv_arc_set_bg_angles(ui->USB_Data_4_arc_5, 135, 45);
	lv_arc_set_value(ui->USB_Data_4_arc_5, 90);
	...
	lv_obj_remove_style(ui->USB_Data_4_arc_5, NULL, LV_PART_KNOB); /* 移除旋钮 */
    lv_obj_clear_flag(ui->USB_Data_4_arc_5, LV_OBJ_FLAG_CLICKABLE); /* 清除可点击属性 */
	...
	lv_arc_set_range(ui->USB_Data_4_arc_4, 0, 330);
	lv_arc_set_bg_angles(ui->USB_Data_4_arc_4, 135, 45);
	lv_arc_set_value(ui->USB_Data_4_arc_4, 30);
	...
	lv_obj_remove_style(ui->USB_Data_4_arc_4, NULL, LV_PART_KNOB); /* 移除旋钮 */
    lv_obj_clear_flag(ui->USB_Data_4_arc_4, LV_OBJ_FLAG_CLICKABLE); /* 清除可点击属性 */
	...
	lv_obj_set_pos(ui->USB_Data_4_label_7, 75, 49);
	...
	lv_obj_set_pos(ui->USB_Data_4_label_8, 240, 49);
	...
	// lv_label_set_text_fmt(ui->USB_Data_4_label_6,"%.2f",(char)adc_voltage[0]*100);
